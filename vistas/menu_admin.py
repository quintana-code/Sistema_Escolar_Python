...
def abrir_menu_admin(id_usuario, nombre_usuario, rol):
    ...
    def cerrar_sesion():
        ...
        if respuesta:
            app.destroy()
            #Es lo mismo que el otro menu para evitar que menu cargue antes que main, lo pondremos aqui :o
    ...
    btn_salir = ctk.CTkButton(app, text="   Cerrar sesión",image=icono_salir,
        compound="left",
        anchor="w",
        height=60,
        fg_color="#F5F5F5",
